...
- **Android / Android TV / Google TV** → [latest APK](https://github.com/khalilbenaz/ultra-tv/releases/latest/download/UltraTV-debug.apk)
  - **Easiest on a TV box** — install the free [Downloader](https://www.aftvnews.com/downloader/) app, open it and type the short code **`5248504`** to fetch the APK directly.
